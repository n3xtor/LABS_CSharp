...
namespace Lab4
{
    class PageDamageEventArgs : EventArgs
    {
        public int PageNumber { get; }
        public string DamageType { get; }

        public PageDamageEventArgs(int pageNumber, string damageType)
        {
    ...
    class Book : IEnumerable<Book>, IEqualityComparer<Book>
    {
        ...
        public void DamagePage(int pageNumber, string damageType)
        {
            ...
            PageDamage?.Invoke(this, new PageDamageEventArgs(pageNumber, damageType));
        }
